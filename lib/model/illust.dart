class MetaPages {
  ...
  MetaPages.fromJson(Map<String, dynamic> json) {
    imageUrls = json['image_urls'] != null ? new MetaPagesImageUrls.fromJson(json['image_urls']) : null;
  }
...
class Illusts {
  ...
  Illusts.fromJson(Map<String, dynamic> json) {
    ...
    title = json['title'];
    type = json['type'];
    imageUrls = json['image_urls'] != null ? new ImageUrls.fromJson(json['image_urls']) : null;
    caption = json['caption'];
    restrict = json['restrict'];
    user = json['user'] != null ? new User.fromJson(json['user']) : null;
    if (json['tags'] != null) {
      illustTags = new List<IllustTags>();
      json['tags'].forEach((v) {
        illustTags.add(new IllustTags.fromJson(v));
      });
    }
    if (json['tools'] != null) {
    ...
    series = json['series'];
    metaSinglePage = json['meta_single_page'] != null ? new MetaSinglePage.fromJson(json['meta_single_page']) : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.illustTags != null) {
      data['tags'] = this.illustTags.map((v) => v.toJson()).toList();
    }
    if (this.tools != null) {
...
class IllustTags {
  ...
  IllustTags({this.name, this.translatedName});

  IllustTags.fromJson(Map<String, dynamic> json) {
    name = json['name'];
