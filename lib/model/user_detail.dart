...
class UserDetail {
  ...
  factory UserDetail.fromJson(jsonRes) => jsonRes == null
      ? null
      : UserDetail(
          user: User.fromJson(jsonRes['user']),
          profile: Profile.fromJson(jsonRes['profile']),
          profile_publicity: Profile_publicity.fromJson(jsonRes['profile_publicity']),
...
class User {
  ...
  factory User.fromJson(jsonRes) => jsonRes == null
      ...
      : User(
          ...
          profile_image_urls: Profile_image_urls.fromJson(jsonRes['profile_image_urls']),
...
class Profile_publicity {
  ...
  factory Profile_publicity.fromJson(jsonRes) => jsonRes == null
      ? null
      : Profile_publicity(
          gender: jsonRes['gender'],
          region: jsonRes['region'],
...
class Workspace {
  ...
  factory Workspace.fromJson(jsonRes) => jsonRes == null
      ? null
      : Workspace(
          pc: jsonRes['pc'],
