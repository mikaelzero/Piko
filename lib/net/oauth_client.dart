...
class OAuthClient {
  ...
  OAuthClient() {
    ...
    (this.httpClient.httpClientAdapter as DefaultHttpClientAdapter).onHttpClientCreate = (client) {
  ...
  Future<Response> postAuthToken(String userName, String passWord, {String deviceToken = "pixiv"}) {
  ...
  Future<Response> postRefreshAuthToken({refreshToken: String, deviceToken: String}) {
    return httpClient.post("/auth/token", data: {
      "client_id": CLIENT_ID,
      "client_secret": CLIENT_SECRET,
