  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; true; i += 1) {
      ...
      if (day < 1) {
        ...
        TextStyle itemStyle = themeData.textTheme.body1.copyWith(fontFamily: "MPLUS1p");
        ...
        if (isSelectedFirstDay && (isSelectedLastDay == null || isSelectedLastDay)) {
          itemStyle = themeData.accentTextTheme.body2.copyWith(fontFamily: "MPLUS1p");
          decoration = BoxDecoration(
            color: themeData.accentColor,
            boxShadow: [
              BoxShadow(color: themeData.accentColor.withOpacity(0.5), offset: Offset(5.0, 5.0), blurRadius: 10.0, spreadRadius: 2.0),
              BoxShadow(color: themeData.accentColor)
            ],
          ...
          decoration = BoxDecoration(
            color: themeData.accentColor,
            boxShadow: [
              BoxShadow(color: themeData.accentColor.withOpacity(0.06), offset: Offset(5.0, 5.0), blurRadius: 10.0, spreadRadius: 2.0),
              BoxShadow(color: themeData.accentColor)
            ],
            borderRadius: BorderRadius.all(Radius.circular(10.0)),
          );
          ...
          decoration = BoxDecoration(color: themeData.accentColor.withOpacity(0.06), shape: BoxShape.rectangle);
        } else if (disabled) {
          itemStyle = themeData.textTheme.body1.copyWith(color: themeData.disabledColor,fontFamily: "MPLUS1p");
        } else if (currentDate.year == year && currentDate.month == month && currentDate.day == day) {
          // The current day gets a different text color.
          itemStyle = themeData.textTheme.body2.copyWith(color: themeData.accentColor,fontFamily: "MPLUS1p");
        }
            ...
            child: new Semantics(
              ...
              child: new FadeTransition(
                ...
                child: new IconButton(
                  ...
                  tooltip:
                      _isDisplayingFirstMonth ? null : '${localizations.previousMonthTooltip} ${localizations.formatMonthYear(_previousMonthDate)}',
